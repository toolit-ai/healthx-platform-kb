...
const playbooks = [
  ...
  { slug: 'weekend_option', name: 'Weekend Option', checks: 8, status: 'fully_implemented', roc: false },
  { slug: 'break_exceptions', name: 'Break Exceptions', checks: 7, status: 'fully_implemented', roc: false },
  { slug: 'punch_exceptions', name: 'Punch Exceptions', checks: 7, status: 'fully_implemented', roc: false },
  { slug: 'consecutive_days', name: 'Consecutive Days', checks: 6, status: 'fully_implemented', roc: false },
  { slug: 'premium_labor', name: 'Premium Labor', checks: 6, status: 'fully_implemented', roc: false },
  { slug: 'one_off_practices', name: 'One-Off Pay Practices', checks: 6, status: 'fully_implemented', roc: false },
  { slug: 'incidental_overtime', name: 'Incidental Overtime', checks: 6, status: 'fully_implemented', roc: false },
  { slug: 'schedule_effectiveness', name: 'Schedule Effectiveness', checks: 5, status: 'fully_implemented', roc: false },
  { slug: 'stacking', name: 'Stacking', checks: 5, status: 'fully_implemented', roc: false },
]
